...
from data_gen import load_test_data_for_rnn, load_train_data_for_rnn, load_test_data_for_cnn, load_train_data_for_cnn, \
    erath_data_transform, sea_mask_rnn, sea_mask_cnn, _get_k_shot
...
def train(x,
          ...
          num_task=None,
          valid_split=True):
    # np.savetxt("static.csv", static[:,:,-1], delimiter=",")
    # np.savetxt("static_climate.csv", static_climate[:,:,-1], delimiter=",")
...
#	filter Antatctica
    ...
    # np.savetxt("mask_s.csv", static, delimiter=",")
    # np.savetxt("mask_sc.csv", static_climate, delimiter=",")
    # train and validate
